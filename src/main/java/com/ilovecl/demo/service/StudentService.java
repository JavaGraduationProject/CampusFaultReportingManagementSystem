...
public interface StudentService {
     ...
     * @return
     */
    boolean addStudent(String id, String name, String password, int sexual, String email, String phone,String door);
     ...
     * @return
     */
    boolean updateStudent(String id, String name, String password, int sexual, String email, String phone,String door);

...
public class StudentServiceImpl implements StudentService {
     ...
     */
    @Override
    public boolean addStudent(String id, String name, String password, int sexual, String email, String phone,String door) {
        studentDao.add(new Student(id, name, password, sexual, email, phone,door));
     ...
     */
    @Override
    public boolean updateStudent(String id, String name, String password, int sexual, String email, String phone,String door) {
        ...
        studentDao.update(new Student(id, name, password, sexual, email, phone,door));
